...
run_step "Hydrate check" cargo check --features hydrate --target wasm32-unknown-unknown
...
run_step "SQLite provider contracts" cargo test -p infrastructure sqlite_
