...
run_step "Identity module Clippy" cargo clippy --all-features -p identity_domain_shared -p identity_domain -p identity_application_contracts -p identity_application -- -D warnings
...
run_step "Identity module contract tests" cargo test --all-features -p identity_domain_shared -p identity_domain -p identity_application_contracts -p identity_application
